...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::mprpc::RpcHeader, paramsize_),
};
...
const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\n\tparamSize\030\003 \001(\rb\006proto3"
  ;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          paramsize_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* RpcHeader::_InternalSerialize(
  ...
  if (this->paramsize() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(3, this->_internal_paramsize(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:mprpc.RpcHeader)
  ...
  if (from.paramsize() != 0) {
    _internal_set_paramsize(from._internal_paramsize());
  }
}
...
void RpcHeader::InternalSwap(RpcHeader* other) {
  ...
  swap(paramsize_, other->paramsize_);
}
